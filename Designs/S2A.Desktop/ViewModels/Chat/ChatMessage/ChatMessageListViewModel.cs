...
namespace S2A.Desktop
{
    ...
    public class ChatMessageListViewModel : BaseViewModel
    {
        ...
        /// </summary>
        protected ObservableCollection<ChatMessageListItemViewModel> CurrentItems;

        /// <summary>
        /// A flag indicating if the search dialog is open
        /// </summary>
        protected bool CurrentSearchIsOpen;
        ...
        public ObservableCollection<ChatMessageListItemViewModel> Items
        {
            ...
            set
            {
                ...
                FilteredItems = new ObservableCollection<ChatMessageListItemViewModel>(CurrentItems);
            }
        }
        ...
        {
            get => CurrentSearchIsOpen;
            set
            {
                // Check value has changed
                if (CurrentSearchIsOpen == value)
                    return;

                // Update value
                CurrentSearchIsOpen = value;

                // If dialog closes...
                if (!CurrentSearchIsOpen)
                    // Clear search text
